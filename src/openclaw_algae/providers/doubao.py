...
from openclaw_algae.providers.prompts import build_doubao_prompt
...
class DoubaoWebAdapter(ProviderAdapter):
    ...
    def chat(
        ...
        if credentials is None:
            raise RuntimeError("Missing Doubao credentials. Run `openclaw-algae login doubao` first.")
...
def _parse_doubao_response_text(payload: str) -> str:
    ...
    if (
        ...
        raise ProviderRateLimitError(
            ...
            "`openclaw-algae login doubao` to refresh credentials."
        )
