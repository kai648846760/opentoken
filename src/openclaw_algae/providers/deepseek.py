...
from openclaw_algae.models.model_aliases import normalize_provider_model
...
from openclaw_algae.providers.deepseek_hash_v1_wasm import DEEPSEEK_HASH_V1_WASM_B64
...
class DeepSeekWebAdapter(ProviderAdapter):
    ...
    def chat(
        ...
        if credentials is None:
            raise RuntimeError("Missing DeepSeek credentials. Run `openclaw-algae login deepseek` first.")
