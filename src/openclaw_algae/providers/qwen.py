...
from openclaw_algae.providers.prompts import build_qwen_prompt
...
class QwenWebAdapter(ProviderAdapter):
    ...
    def chat(
        ...
        if credentials is None:
            raise RuntimeError("Missing Qwen credentials. Run `openclaw-algae login qwen international` first.")
...
class QwenCnWebAdapter(ProviderAdapter):
    ...
    def chat(
        ...
        if credentials is None:
            raise RuntimeError("Missing Qwen CN credentials. Run `openclaw-algae login qwen china` first.")
